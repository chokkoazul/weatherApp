...
public class LoggerAspect {
    ...
    @Around("@annotation(com.cosorio.weather.aspect.annotation.Monitor) || @within(com.cosorio.weather.aspect.annotation.Monitor)")
    public Object logRelevantInformation(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            LogMessageBuilder afterLog = LogMessageBuilder.builder()
                    .className(className)
                    .method(methodName)
